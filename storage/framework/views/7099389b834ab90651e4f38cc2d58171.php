    ...
    <script>
        ...
        function getDesignation(did) {
            $.ajax({
                ...
                //     $('#branch_id').empty();
                //     $('#branch_id').append('<option value=""><?php echo e(__('Select Branch')); ?></option>');
                //     $.each(data, function(key, value) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/employee/profile.blade.php ENDPATH**/ ?>