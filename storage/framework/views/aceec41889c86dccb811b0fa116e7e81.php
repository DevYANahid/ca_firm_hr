...
<div class="modal-body">
    ...
    <div class="card-footer text-end">
        <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="<?php echo e(route('generate', ['promotion'])); ?>"
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <?php echo e(Form::text('promotion_date', null, ['class' => 'form-control d_week current_date','autocomplete'=>'off' , 'required' => 'required'])); ?>
...
</script><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/promotion/create.blade.php ENDPATH**/ ?>