...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo Form::date('joining_date', null, ['class' => 'form-control current_date','autocomplete'=>'off']); ?>
...
</script><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/jobApplication/onboardCreate.blade.php ENDPATH**/ ?>