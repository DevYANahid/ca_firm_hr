                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Set Salary')): ?>
                                <div class="col-1 text-end">
                                    ...
                                    <a data-url="<?php echo e(route('employee.basic.salary', $employee->id)); ?>" data-ajax-popup="true"
                                        data-title="<?php echo e(__('Set Basic Sallary')); ?>" data-bs-toggle="tooltip" title=""
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Allowance')): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a class="mx-3 btn btn-sm  align-items-center"
                                                                ...
                                                                title="" data-title="<?php echo e(__('Edit Allowance')); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Commission')): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a class="mx-3 btn btn-sm  align-items-center"
                                                                ...
                                                                data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip"
                                                                title="" data-title="<?php echo e(__('Edit Commission')); ?>"
                                                                data-bs-original-title="<?php echo e(__('Edit')); ?>">
                                                                <i class="ti ti-pencil text-white"></i>
                                                            </a>
                                                        </div>
                        ...
                        <div class="row">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Other Payment')): ?>
                                <div class="col-1 text-end">
                                    ...
                                    <a data-url="<?php echo e(route('otherpayments.create', $employee->id)); ?>" data-ajax-popup="true"
                                        data-title="<?php echo e(__('Create Other Payment')); ?>" data-bs-toggle="tooltip"
                                        title="" class="btn btn-sm btn-primary"
                                        data-bs-original-title="<?php echo e(__('Create')); ?>">
                                        <i class="ti ti-plus"></i>
                                    </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/setsalary/employee_salary.blade.php ENDPATH**/ ?>