...
<div class="app-modal" data-name="settings">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="update-settings" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data"
                method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="app-modal-body">
                    ...
                    <div class="avatar av-l upload-avatar-preview"
                        style="background-image: url('<?php echo e($profile . '/' . Auth::user()->avatar); ?>');"></div>
                    ...
                    <div class="update-messengerColor">
                        <?php $__currentLoopData = config('chatify.colors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span style="background-color: <?php echo e($color); ?>" data-color="<?php echo e($color); ?>"
...
<?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>