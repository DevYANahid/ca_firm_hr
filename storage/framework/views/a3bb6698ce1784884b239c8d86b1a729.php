                                        ...
                                        <div class="user-group">
                                            <?php $__currentLoopData = $ZoomMeeting->users($ZoomMeeting->user_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img alt="image" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    ...
                                                    <?php if($projectUser->avatar): ?> src="<?php echo e(asset(Storage::url('uploads/avatar/')) . '/' . $projectUser->avatar); ?>" <?php else: ?> src="<?php echo e(asset(Storage::url('uploads/avatar/avatar.png'))); ?>" <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/zoom_meeting/index.blade.php ENDPATH**/ ?>