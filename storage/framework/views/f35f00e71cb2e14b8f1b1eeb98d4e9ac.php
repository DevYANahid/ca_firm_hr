                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="choose-files ">
                                            <label for="profile">
                                                ...
                                                <img id="blah"  width="100" style="border-radius: 50%" src="<?php echo e(!empty($userDetail->avatar) ? $profile . $userDetail->avatar : $profile . '/avatar.png'); ?>" />
                                            </label>
                                        </div>
                                        <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/user/profile.blade.php ENDPATH**/ ?>