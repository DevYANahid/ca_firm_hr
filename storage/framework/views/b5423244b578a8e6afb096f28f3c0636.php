...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <img id="<?php echo e('blah' . $key); ?>"
                                                        src="<?php echo e(isset($employeedoc[$document->id]) && !empty($employeedoc[$document->id]) ? $logo . '/' . $employeedoc[$document->id] : asset(Storage::url("uploads/avatar/defualt.png"))); ?>"
                                                        width="50%" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/employee/edit.blade.php ENDPATH**/ ?>