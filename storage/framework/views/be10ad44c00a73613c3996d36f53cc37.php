                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            <div class="col ml-n2">
                                                                <p class="card-text small text-muted">
                                                                    <img class="rounded" src="<?php echo e($logo . '/' . $home_logo); ?>"
                                                                        width="70px" alt="Image placeholder"
                                                                        data-dz-thumbnail="">
                                                                </p>
                                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\Modules/LandingPage\Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>