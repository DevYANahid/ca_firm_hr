                        ...
                        <tbody>
                            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'company')): ?>
                                        <td><?php echo e(!empty($ticket->employee_id) ? $ticket->getUsers->name : ''); ?>

                                        </td>
                                    <?php endif; ?>
                                    <td>
                                        <?php if($ticket->priority == 'medium'): ?>
                                            <div class="status_badge text-capitalize badge bg-info p-2 px-3 rounded"><?php echo e(__('Medium')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/ticket/index.blade.php ENDPATH**/ ?>