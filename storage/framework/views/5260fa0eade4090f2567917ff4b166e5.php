                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <?php echo Form::text('title', null, ['class' => 'form-control','required' => 'required', 'placeholder' => 'Enter job title']); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo Form::text('position', null, ['class' => 'form-control','required' => 'required', 'placeholder' => 'Enter job Positions']); ?>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple-2" name="description" id="description" rows="3"><?php echo e($job->description); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple" name="requirement" id="requirement" rows="3"><?php echo e($job->requirement); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\CA-Firm-HR-main\resources\views/job/edit.blade.php ENDPATH**/ ?>